                                    ...
                                    <div class="modal-content modalSerieMoment">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="text-center">
                                                <a href="view/pages/page_info_series.php?id=1"><img src="assets/images/imgSeries/13ReasonsWhy.jpg" class="img-fluid img-thumbnail imgMomentAccueil" alt="Sheep" /></a>
                                            </div>
                                        </div>
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                    <div class="modal-content modalSerieMoment">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="text-center">
                                                <a href="view/pages/page_info_series.php?id=2"><img src="assets/images/imgSeries/supernatural.jpg" class="img-fluid img-thumbnail imgMomentAccueil" alt="Sheep" /></a>
                                            </div>
                                        </div>
                                        <div class="modal-footer border-top-0 d-flex justify-content-between">
                                            <button type="button" class="btn btn-light text-dark" data-dismiss="modal">Retour</button>
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                    <div class="modal-content modalSerieMoment">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="text-center">
                                                <a href="view/pages/page_info_series.php?id=4"><img src="assets/images/imgSeries/breakingBad.jpg" class="img-fluid img-thumbnail imgMomentAccueil" alt="Sheep" /></a>
                                            </div>
                                        </div>
                                        <div class="modal-footer border-top-0 d-flex justify-content-between">
                                            <button type="button" class="btn btn-light text-dark" data-dismiss="modal">Retour</button>
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                    <div class="modal-content modalSerieMoment">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="text-center">
                                                <a href="view/pages/page_info_series.php?id=5"><img src="assets/images/imgSeries/gameOfThrones.jpg" class="img-fluid img-thumbnail imgMomentAccueil" alt="Sheep" /></a>
                                            </div>
                                        </div>
                                        <div class="modal-footer border-top-0 d-flex justify-content-between">
                                            <button type="button" class="btn btn-light text-dark" data-dismiss="modal">Retour</button>
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                    <div class="modal-content modalSerieMoment">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="text-center">
                                                <a href="view/pages/page_info_series.php?id=6"><img src="assets/images/imgSeries/lucifer.jpg" class="img-fluid img-thumbnail imgMomentAccueil" alt="Sheep" /></a>
                                            </div>
                                        </div>
                                        <div class="modal-footer border-top-0 d-flex justify-content-between">
                                            <button type="button" class="btn btn-light text-dark" data-dismiss="modal">Retour</button>
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                    <div class="modal-content modalSerieMoment">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="text-center">
                                                <a href="view/pages/page_info_series.php?id=7"><img src="assets/images/imgSeries/theWalkingDead.jpg" class="img-fluid img-thumbnail imgMomentAccueil" alt="Sheep" /></a>
                                            </div>
                                        </div>
                                        <div class="modal-footer border-top-0 d-flex justify-content-between">
                                            <button type="button" class="btn btn-light text-dark" data-dismiss="modal">Retour</button>
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                    <div class="modal-content modalSerieMoment">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="text-center">
                                                <a href="view/pages/page_info_series.php?id=8"><img src="assets/images/imgSeries/theBigBangTheory.jpg" class="img-fluid img-thumbnail imgMomentAccueil" alt="Sheep" /></a>
                                            </div>
                                        </div>
                                        <div class="modal-footer border-top-0 d-flex justify-content-between">
                                            <button type="button" class="btn btn-light text-dark" data-dismiss="modal">Retour</button>
