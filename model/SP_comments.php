...
class Comments extends Database
{
    ...
    public function insertComments()
    {
        ...
        $reqInsertComments->bindValue(':sp_message', $this->sp_message);
        $reqInsertComments->bindValue(':sp_date_message', $this->sp_date_message);
        $reqInsertComments->bindValue(':sp_id_users', $this->sp_id_users);
        $reqInsertComments->bindValue(':sp_id_series_pages', $this->sp_id_series_pages);
    ...
    public function selectComments()
    {
        ...
        $reqSelectComments->bindValue(':id', $this->sp_id_series_pages);
    ...
    public function deleteComments()
    {
        ...
        $reqDeleteComments->bindValue(':id', $this->id);
