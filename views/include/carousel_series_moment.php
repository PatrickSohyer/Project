            ...
            <div class="row">
              <div class="col-md-6 col-lg-3 col-xl-3 col-12 mb-3">
                <div class="Modals mx-auto text-center">
                  <a class="btnModalsAcceuil" data-toggle="modal" data-target="#reasonsWhyModals"><img src="images/imgSeries/13ReasonsWhy.jpg" class="imgMomentAccueil" /></a>
                  ...
                  <div class="modal-content modalSerieMoment">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="text-center">
                        <img src="images/imgSeries/13ReasonsWhy.jpg" class="img-fluid img-thumbnail imgMomentAccueil" alt="Sheep" />
                      </div>
                    </div>
              ...
              <div class="col-md-6 col-lg-3 col-xl-3 col-12 mb-3">
                <div class="Modals mx-auto text-center">
                  <a class="btnModalsAcceuil" data-toggle="modal" data-target="#supernaturalModals"><img src="images/imgSeries/supernatural.jpg" class="imgMomentAccueil" /></a>
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                  <div class="modal-content modalSerieMoment">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="text-center">
                        <img src="images/imgSeries/supernatural.jpg" class="img-fluid img-thumbnail imgMomentAccueil" alt="Sheep" />
                      </div>
                    </div>
                    <div class="modal-footer border-top-0 d-flex justify-content-between">
                      <button type="button" class="btn btn-light text-dark" data-dismiss="modal">Retour</button>
              ...
              <div class="col-md-6 col-lg-3 col-xl-3 col-12 mb-3">
                <div class="Modals mx-auto text-center">
                  <a class="btnModalsAcceuil" data-toggle="modal" data-target="#theFlashModals"><img src="images/imgSeries/theFlash.jpg" class="imgMomentAccueil" /></a>
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                  <div class="modal-content modalSerieMoment">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="text-center">
                        <img src="images/imgSeries/theFlash.jpg" class="img-fluid img-thumbnail imgMomentAccueil" alt="Sheep" />
                      </div>
                    </div>
                    <div class="modal-footer border-top-0 d-flex justify-content-between">
                      <button type="button" class="btn btn-light text-dark" data-dismiss="modal">Retour</button>
              ...
              <div class="col-md-6 col-lg-3 col-xl-3 col-12 mb-3">
                <div class="Modals mx-auto text-center">
                  <a class="btnModalsAcceuil" data-toggle="modal" data-target="#breakingBadModals"><img src="images/imgSeries/breakingBad.jpg" class="imgMomentAccueil" /></a>
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                  <div class="modal-content modalSerieMoment">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="text-center">
                        <img src="images/imgSeries/breakingBad.jpg" class="img-fluid img-thumbnail imgMomentAccueil" alt="Sheep" />
                      </div>
                    </div>
                    <div class="modal-footer border-top-0 d-flex justify-content-between">
                      <button type="button" class="btn btn-light text-dark" data-dismiss="modal">Retour</button>
          ...
          <div class="carousel-item">
            <div class="row">
              <div class="col-md-6 col-lg-3 col-xl-3 col-sm-12 mb-3">
                <div class="Modals mx-auto text-center">
                  <a class="btnModalsAcceuil" data-toggle="modal" data-target="#gameOfThronesModals"><img src="images/imgSeries/gameOfThrones.jpg" class="imgMomentAccueil" /></a>
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                  <div class="modal-content modalSerieMoment">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="text-center">
                        <img src="images/imgSeries/gameOfThrones.jpg" class="img-fluid img-thumbnail imgMomentAccueil" alt="Sheep" />
                      </div>
                    </div>
                    <div class="modal-footer border-top-0 d-flex justify-content-between">
                      <button type="button" class="btn btn-light text-dark" data-dismiss="modal">Retour</button>
              ...
              <div class="col-md-6 col-lg-3 col-xl-3 col-12 mb-3">
                <div class="Modals mx-auto text-center">
                  <a class="btnModalsAcceuil" data-toggle="modal" data-target="#luciferModals"><img src="images/imgSeries/lucifer.jpg" class="imgMomentAccueil" /></a>
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                  <div class="modal-content modalSerieMoment">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="text-center">
                        <img src="images/imgSeries/lucifer.jpg" class="img-fluid img-thumbnail imgMomentAccueil" alt="Sheep" />
                      </div>
                    </div>
                    <div class="modal-footer border-top-0 d-flex justify-content-between">
                      <button type="button" class="btn btn-light text-dark" data-dismiss="modal">Retour</button>
              ...
              <div class="col-md-6 col-lg-3 col-xl-3 col-12 mb-3">
                <div class="Modals mx-auto text-center">
                    <a class="btnModalsAcceuil" data-toggle="modal" data-target="#theWalkingDeadModals"><img src="images/imgSeries/theWalkingDead.jpg" class="imgMomentAccueil" /></a>
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                  <div class="modal-content modalSerieMoment">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="text-center">
                        <img src="images/imgSeries/theWalkingDead.jpg" class="img-fluid img-thumbnail imgMomentAccueil" alt="Sheep" />
                      </div>
                    </div>
                    <div class="modal-footer border-top-0 d-flex justify-content-between">
                      <button type="button" class="btn btn-light text-dark" data-dismiss="modal">Retour</button>
              ...
              <div class="col-md-6 col-lg-3 col-xl-3 col-12 mb-3">
                <div class="Modals mx-auto text-center">
                  <a class="btnModalsAcceuil" data-toggle="modal" data-target="#theBigBangTheoryModals"><img src="images/imgSeries/theBigBangTheory.jpg" class="imgMomentAccueil" /></a>
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                  <div class="modal-content modalSerieMoment">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="text-center">
                        <img src="images/imgSeries/theBigBangTheory.jpg" class="img-fluid img-thumbnail imgMomentAccueil" alt="Sheep" />
                      </div>
                    </div>
                    <div class="modal-footer border-top-0 d-flex justify-content-between">
                      <button type="button" class="btn btn-light text-dark" data-dismiss="modal">Retour</button>
